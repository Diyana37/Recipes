...
{
    /// <inheritdoc />
    public partial class AddedAdditionalCheckConstraints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeNationalities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeNationalityId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Recipe_CookingTime", "[CookingTime] BETWEEN 0 AND 1000");
                    table.CheckConstraint("CHK_Recipe_Difficulty", "[Difficulty] BETWEEN 1 AND 10");
                    table.CheckConstraint("CHK_Recipe_Portions", "[Portions] BETWEEN 1 AND 100");
                    table.CheckConstraint("CHK_Recipe_PreparationTime", "[PreparationTime] BETWEEN 0 AND 1000");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RecipeNationalityId,
